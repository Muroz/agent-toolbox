"""Canonical token-cost model (mirrors the copy in claude-performance-tracker).
...
here used to do — makes a ticket that reuses a long cached prefix look far more
